                ...
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    <div v-for="(link, index) in paginator.links">
                        <inertia-link
                            ...
                            "
                            :class="{ 'bg-primary-200': link.active === true }"
                            :href="link.url"
                            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-primary-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
                        >
                            {{ link.label }}
                        </inertia-link>
                        <span
