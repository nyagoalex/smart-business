            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <h2 class="opacity-75 font-medium">Add Product</h2>
                            <XMarkIcon
                        ...
                        <div class="space-y-4 pb-8 px-3 sm:px-8">
                            <dl
                                class="grid grid-cols-1 sm:grid-cols-1 md:gap-x-6 md:gap-y-1 pb-6 py-2"
                            >
                                <base-input
                                    v-model="form.name"
